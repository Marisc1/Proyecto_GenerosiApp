...
import com.GenerosiApp.service.AdministradorService;
import com.GenerosiApp.service.SolicitudService;
...
public class IndexController {
    ...
    public String nuevoSolicitud(Solicitud solicitud) {
    ...
    @GetMapping("/modificarSolicitud/{id_solicitud}")
    ...
    @GetMapping("/eliminarSolicitud/{id_solicitud}")
